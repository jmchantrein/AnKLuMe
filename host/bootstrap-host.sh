...
#
# Prérequis :
#   - Debian 13 installé (LUKS + btrfs, voir docs/guide/host-setup.md)
#   - Pool ZFS "tank" déjà créé (avec keyfile /root/.zfs-key)
#   - Exécuter en root
#
# Usage :
