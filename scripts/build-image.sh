...
FSTAB
  ...
  ║  anklume Live OS                                ║
  ║                                                 ║
  ║  User: anklume    Password: anklume             ║
  ║  Root password:   anklume                       ║
  ║                                                 ║
  ║  Getting started:                               ║
  ║    anklume --help     All commands               ║
  ║    anklume console    Domain console             ║
  ║    anklume lab list   Guided exercises           ║
  ╚══════════════════════════════════════════════════╝

MOTD
    info "  Login motd configured"
