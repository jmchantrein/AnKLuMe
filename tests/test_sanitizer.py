...
class TestAiProviderValidation:
    ...
    def test_omitted_provider_is_valid(self):  # Matrix: LS-001
...
class TestAiSanitizeValidation:
    ...
    def test_omitted_sanitize_is_valid(self):  # Matrix: LS-003
        """Omitting ai_sanitize is valid (auto-defaults in generator)."""
        infra = _base_infra()
        assert validate(infra) == []


# -- Generation / propagation tests (Matrix: LS-005, LS-006) ----------------


class TestAiPropagation:
    def test_default_local_propagation(self, tmp_path):  # Matrix: LS-005
    ...
    def test_cloud_defaults_sanitize_true(self, tmp_path):  # Matrix: LS-005
    ...
    def test_local_first_defaults_sanitize_true(self, tmp_path):  # Matrix: LS-005
    ...
    def test_explicit_sanitize_overrides_default(self, tmp_path):  # Matrix: LS-006
    ...
    def test_always_sanitize_propagated(self, tmp_path):  # Matrix: LS-006
...
# -- Pattern matching tests (Matrix: LS-007) ----------------------------------
...
class TestIpPatterns:
    def test_anklume_zone_ip(self):  # Matrix: LS-007
    ...
    def test_rfc1918_class_b(self):  # Matrix: LS-007
    ...
    def test_rfc1918_class_c(self):  # Matrix: LS-007
    ...
    def test_subnet_cidr(self):  # Matrix: LS-007
...
class TestIncusPatterns:
    def test_bridge_name(self):  # Matrix: LS-007
    ...
    def test_fqdn_internal(self):  # Matrix: LS-007
...
class TestCredentialPatterns:
    def test_bearer_token(self):  # Matrix: LS-007
    ...
    def test_api_key(self):  # Matrix: LS-007
    ...
    def test_generic_secret(self):  # Matrix: LS-007
    ...
    def test_ssh_key(self):  # Matrix: LS-007
...
class TestAnsiblePatterns:
    def test_group_vars_path(self):  # Matrix: LS-007
    ...
    def test_host_vars_path(self):  # Matrix: LS-007
    ...
    def test_ansible_host(self):  # Matrix: LS-007
